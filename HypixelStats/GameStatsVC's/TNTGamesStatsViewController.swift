...
class TNTGamesStatsViewController: GenericStatsViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    lazy var statsTableData: [CellData] = {
        ...
        var wlrTNTRun = GameTypes.calculateKDR(kills: winsTNTRun, deaths: lossesTNTRun)
        ...
        var wlrPVPRun = GameTypes.calculateKDR(kills: winsPVPRun, deaths: lossesPVPRun)
        var kdrPVPRun = GameTypes.calculateKDR(kills: killsPVPRun, deaths: lossesPVPRun)
        
        var winsSpleef = data["wins_bowspleef"].intValue ?? 0
        var lossesSpleef = data["deaths_bowspleef"].intValue ?? 0
        var wlrSpleef = GameTypes.calculateKDR(kills: winsSpleef, deaths: lossesSpleef)
